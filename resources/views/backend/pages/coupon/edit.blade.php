...
@section('admin_content')
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('coupon.update', $edit_coupon->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="coupon_name" class="form-label">Coupon Name</label>
                            <input type="text" name="coupon_name" value="{{ $edit_coupon->coupon_name }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="discount_amount" value="{{ $edit_coupon->discount_amount }}"
                                class="form-control
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="minimum_purchase_amount"
                                value="{{ $edit_coupon->minimum_purchase_amount }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="validity_till" value="{{ $edit_coupon->validity_till }}"
