...
@section('admin_content')
    <div class="row">
        <div class="col-12 d-flex justify-content-between mb-4">
            ...
            <a href="{{ route('product.index') }}" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i>
                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('short_description') is-invalid @enderror" name="short_description"
                                id="short_description" cols="30" rows="3" placeholder="Enter Product Short Description">{{ $product->short_description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('long_description') is-invalid @enderror" name="long_description"
                                id="long_description" cols="30" rows="5" placeholder="Enter Product Long Description">{{ $product->long_description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('additional_info') is-invalid @enderror" name="additional_info"
                                id="additional_info" cols="30" rows="2" placeholder="Enter Product Additional Information">{{ $product->additional_info }}</textarea>
