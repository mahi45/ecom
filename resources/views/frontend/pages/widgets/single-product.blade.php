...
@section('frontend_title', 'Single Product Page')

@section('frontend_content')
    @include('frontend.layouts.inc.breadcumb', ['pagename' => $product->name])
                    ...
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            ...
                            @foreach ($product->productImages as $images)
                                <div class="item">
                                    <img src="{{ asset('uploads/products/') }}/{{ $images->product_multiple_image }}"
                                        alt="">
                                </div>
                            @endforeach
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="featured-product-wrap">
                            <div class="featured-product-img">
                                <img src="{{ asset('uploads/products') }}/{{ $related_product->product_image }}"
                                    alt="">
                            </div>
                            <div class="featured-product-content">
                                <div class="row">
                                    <div class="col-7">
                                        <h3><a
                                                href="{{ route('productdetails.page', $related_product->slug) }}">{{ $related_product->name }}</a>
                                        </h3>
