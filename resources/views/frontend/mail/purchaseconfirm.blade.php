                ...
                @foreach ($order_details as $order)
                    <div class="row contacts">
                        <div class="col invoice-to">
                            ...
                            <div class="address"> <i class="fa fa-home" aria-hidden="true"></i>
                                {{ $order->billing->address }}</div>
                            <div class="phoneNumber"> <i class="fa fa-mobile" aria-hidden="true"></i>
                                {{ $order->billing->phone_number }}</div>
                            <div class="email"><a href="mailto:john@example.com"> <i class="fa fa-envelope"
                                        aria-hidden="true"></i> {{ $order->billing->email }}</a></div>
                        </div>
